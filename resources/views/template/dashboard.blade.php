        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-4">
              ...
              <div class="progress">
                <div style="width: 73%" class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0"
                  aria-valuemax="100"></div>
              </div>
              <br>
              <h6>Completed purchase <small>(32%)</small></h6>
              <div class="progress">
                <div style="width: 32%" class="progress-bar bg-warning" role="progressbar" aria-valuenow="0"
                  aria-valuemin="0" aria-valuemax="100"></div>
              </div>
              <br>
              <h6>Abandon carts <small>(68%)</small></h6>
              <div class="progress">
                <div style="width: 68%" class="progress-bar bg-danger" role="progressbar" aria-valuenow="0"
                  aria-valuemin="0" aria-valuemax="100"></div>
              </div>
              <br>
              <h6>Wishlist <small>(38%)</small></h6>
              <div class="progress">
                <div style="width:38%" class="progress-bar bg-info" role="progressbar" aria-valuenow="0" aria-valuemin="0"
                  aria-valuemax="100"></div>
              </div>
            </div>
            <div class="col-lg-8">
          ...
          <table class="table mb-0">
            ...
            <tbody>
              <tr>
                ...
                <td>Shoe X</td>
                <td>
                  <div class="badge badge-success text-light">delivered</div>
                </td>
              ...
              <tr>
                ...
                <td>Shoe ABC</td>
                <td>
                  <div class="badge badge-warning text-dark">on process</div>
                </td>
              ...
              <tr>
                ...
                <td>Bag DEF</td>
                <td>
                  <div class="badge badge-danger text-white">canceled</div>
                </td>
              ...
              <tr>
                ...
                <td>Keyboard ABC</td>
                <td>
                  <div class="badge badge-dark text-light">refunded</div>
                </td>
      ...
      <div class="card">
        ...
        <div class="card-body px-0">
          ...
          <ul class="list-group list-group-flush mt-4">
            <li class="list-group-item">Gaming <span class="float-right fs-smaller"> <span class="oi oi-caret-top text-success"></span>
                22%</span> </li>
            <li class="list-group-item">Sports <span class="float-right fs-smaller"> <span class="oi oi-caret-bottom text-danger"></span>
                1%</span> </li>
            <li class="list-group-item">Bags <span class="float-right fs-smaller"> <span class="oi oi-caret-top text-success"></span>
                14%</span> </li>
          </ul>
        </div>
      </div>
